...
void GPABGH_IRQHandler(void)
{
    ...
    if(((((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)))->INTSRC & ((0x00000004UL))))
    {
        ((((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)))->INTSRC = ((0x00000004UL)));
    ...
    else
    {
        ...
        temp = ((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040))->INTSRC;
        ((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040))->INTSRC = temp;
...
int main()
{
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)),(0x00004000UL), 0x1UL);
	  GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) )),(0x00000001UL), 0x1UL);
	
		GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)),(0x00000004UL), 0x0UL);
  	GPIO_EnableInt(((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)), 2, 0x00010000UL);
    NVIC_EnableIRQ(GPIO_PAPBPGPH_IRQn);
	
	
	(((GPIO_DBCTL_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0440))->DBCTL = ((0x1ul << (5)) | ((0x1UL<<(4))) | ((0x8UL<<(0)))));
	((((GPIO_T *) (((( uint32_t)0x40000000) + 0x4000) + 0x0040)))->DBEN |= ((*((volatile uint32_t *)(((((( uint32_t)0x40000000) + 0x4000) + 0x0800)+(0x40*(1))) + ((2)<<2))))));
